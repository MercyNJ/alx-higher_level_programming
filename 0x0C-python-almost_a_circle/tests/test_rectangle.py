#!/usr/bin/python3
# test_rectangle.py
"""Contains unittests for rectangle module
"""
...
class Test_Rectangle_instantiation(unittest.TestCase):
    """Rectangle class's instantiation unittests."""
...
class Test_Rectangle_width(unittest.TestCase):
    """Rectangle width attribute's initialization unittests."""
...
class Test_Rectangle_height(unittest.TestCase):
    """Rectangle height attribute initializatin unit tests."""
...
class Test_Rectangle_x(unittest.TestCase):
    """Rectangle x attribute initilalization unittest."""
...
class Test_Rectangle_y(unittest.TestCase):
    """Rectangle y attribute's initilalization unittests."""
...
class Test_Rectangle_order_of_initialization(unittest.TestCase):
    """Rectangle's order of attr initialization unittests."""
...
class Test_Rectangle_area(unittest.TestCase):
    """area method of the Rectangle class's unittests."""
...
class Test_Rectangle_stdout(unittest.TestCase):
    """__str__ and display methods of Rectangle class's unitttests."""
...
class Test_Rectangle_update_args(unittest.TestCase):
    """update args method of the Rectangle class's unittests."""
    ...
    def test_update_args_width_ve(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            r.update(89, -5)
    ...
    def test_update_args_height_ve(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "height must be > 0"):
            r.update(89, 1, -5)
    ...
    def test_update_args_x_ve(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            r.update(89, 1, 2, -6)
    ...
    def test_update_args_width_b4_height(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
    ...
    def test_update_args_width_b4_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
...
class Test_Rectangle_update_kwargs(unittest.TestCase):
    """update kwargs method of the Rectangle class's unittests."""
...
class Test_Rectangle_to_dictionary(unittest.TestCase):
    """to_dictionary method of the Rectangle class's unittests."""
