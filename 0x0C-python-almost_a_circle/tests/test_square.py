#!/usr/bin/python3
# test_square.py
"""Module contains unittests for square class"""
...
class Test_Square_instantiation(unittest.TestCase):
    """Square class's initialization unittests."""
...
class Test_Square_size(unittest.TestCase):
    """Square class's size initialization unittests."""
...
class Test_Square_x(unittest.TestCase):
    """Square x attribute's size initilaizatoion unittests."""
    ...
    def test_negat_x(self):
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            Square(5, -1, 0)


class Test_Square_y(unittest.TestCase):
    """Square y attribute initialization unittests."""
...
class Test_Square_order_of_initialization(unittest.TestCase):
    """order of Square attribute initialization's unitttests."""
...
class Test_Square_area(unittest.TestCase):
    """area method of the Square class's unittests."""
...
class Test_Square_stdout(unittest.TestCase):
    """__str__ and display methods of Square class's unitttests."""

    @staticmethod
    def capture_stdout(sq, method):
        """Captures and outputs text printed to stdout.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class Test_Square_update_args(unittest.TestCase):
    """update arguments method of the Square class's unittests."""
...
class Test_Square_update_kwargs(unittest.TestCase):
    """update kwargs method of Square class's unittests."""
...
class Test_Square_to_dictionary(unittest.TestCase):
    """to_dictionary method of the Square class's uniteests."""
