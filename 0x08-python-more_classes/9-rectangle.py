...
class Rectangle:
    ...
    def __str__(self) -> str:
        """Returns a diagram of the rectangle objects"""
        if self.__width == 0 or self.__height == 0:
            return ("")
        rectangle = ""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Compares areas of 2 rectangles and returns one that is bigger"""
    ...
    def square(cls, size=0):
        """Creates a new square_rectangle object with equal width and height"""
